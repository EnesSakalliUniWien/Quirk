...
perfGoal(
  ...
  [
    EditorState.empty(new Rect(0, 0, 1000, 1000)),
...
perfGoal(
  ...
  ([
    ...
    let inspector = EditorState.empty(new Rect(0, 0, 1000, 1000));
    ...
    inspector = inspector
      ...
      .withHand(PointerInteractionState.EMPTY.withPos(p1.offsetBy(0, dy)))
      .afterGrabbing();
    inspector = inspector
    ...
    view.tooltips?.begin();
    renderInspector(inspector, view, stats);
  },
  [
    (() => {
    ...
    displayedCircuitFromTextDiagram(
      new Map([
        ["-", undefined],
        ["/", null],
        ["0", null],
