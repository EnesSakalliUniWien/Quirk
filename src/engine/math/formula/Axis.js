...
class Axis {
  ...
  static times(u, v) {
    return Axis.op(
      ...
      (a, b) => {
        throw new DetailedError("Can't multiply axes.", { a, b });
      },
    );
  }
  ...
  static add(u, v) {
    return Axis.op(
      ...
      (a, b) => a + b,
      (a, b) => {
        throw new DetailedError("Can't add axes to numbers.", { a, b });
      },
      (a, b) => {
        throw new DetailedError("Can't add axes to numbers.", { a, b });
      },
  ...
  static subtract(u, v) {
    return Axis.op(
      ...
      (a, b) => a - b,
      (a, b) => {
        throw new DetailedError("Can't subtract axes and numbers.", { a, b });
      },
      (a, b) => {
        throw new DetailedError("Can't subtract axes and numbers.", { a, b });
      },
  ...
  static divide(u, v) {
    return Axis.op(
      ...
      (a, b) => new Axis(a.x / b, a.y / b, a.z / b),
      (a, b) => {
        throw new DetailedError("Can't divide by an axis.", { a, b });
      },
      (a, b) => {
        throw new DetailedError("Can't divide by an axis.", { a, b });
      },
  ...
  static raisedTo(u, v) {
    return Axis.op(
      ...
      (a, b) => Math.pow(a, b),
      (a, b) => {
        throw new DetailedError("Can't raise an axis to a power.", { a, b });
      },
      (a, b) => {
        throw new DetailedError("Can't raise to an axis power.", { a, b });
      },
      (a, b) => {
        throw new DetailedError("Can't raise to an axis power.", { a, b });
      },
...
/**
 * The tokens an axis formula understands.
 * @type {!Map.<!string, *>}
 * @private
 */
Axis._TOKEN_MAP = new Map();
Axis._TOKEN_MAP.set("x", new Axis(1, 0, 0));
Axis._TOKEN_MAP.set("y", new Axis(0, 1, 0));
...
Axis._TOKEN_MAP.set("√", Axis._TOKEN_MAP.get("sqrt"));
