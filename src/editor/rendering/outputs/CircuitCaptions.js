...
import {SUPERPOSITION_GRID_LABEL_SPAN, DISPLAY_CAPTION_WIDTH, DISPLAY_CAPTION_GAP, DISPLAY_WARNING_STRIP_HEIGHT} from '../../geometry/CircuitLayoutConstants.js';
...
function drawLocalStateCaption(context, painter, numWire, chanceCol) {
    ...
    const capW = Math.min(160, context.geometry.rectForSuperpositionDisplay().x - capX - 10);
