...
const ModularMultiplyAccumulateGates = {};
...
ModularMultiplyAccumulateGates.PlusABModRFamily = Gate.buildFamily(
  1,
  16,
  (span, builder) =>
    builder
      ...
      .setBlurb(
        "Adds input A times input B into the target, mod input R.\nOnly affects values below R.",
      )
      ...
      .setActualEffectToShaderProvider((ctx) =>
        MODULAR_MULTIPLY_ACCUMULATE_SHADER.withArgs(
...
ModularMultiplyAccumulateGates.MinusABModRFamily = Gate.buildFamily(
  1,
  16,
  (span, builder) =>
    builder
      ...
      .setBlurb(
        "Subtracts input A times input B out of the target, mod input R.\nOnly affects values below R.",
      )
      .setRequiredContextKeys("Input Range A", "Input Range B", "Input Range R")
      .setExtraDisableReasonFinder(modulusTooBigChecker("R", span))
      .setActualEffectToShaderProvider((ctx) =>
