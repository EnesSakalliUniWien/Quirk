...
VariousXGates.X3 = Gate.fromKnownMatrix(
    "X^⅓",
    QubitMatrix.fromPauliRotation(1 / 6, 0, 0),
    "X^⅓ Gate",
...
VariousXGates.X4 = Gate.fromKnownMatrix(
    "X^¼",
    QubitMatrix.fromPauliRotation(1 / 8, 0, 0),
    "X^¼ Gate",
...
VariousXGates.X8 = Gate.fromKnownMatrix(
    "X^⅛",
    QubitMatrix.fromPauliRotation(1 / 16, 0, 0),
    "X^⅛ Gate",
...
VariousXGates.X16 = Gate.fromKnownMatrix(
    "X^⅟₁₆",
    QubitMatrix.fromPauliRotation(1 / 32, 0, 0),
    "X^⅟₁₆ Gate",
...
VariousXGates.X32 = Gate.fromKnownMatrix(
    "X^⅟₃₂",
    QubitMatrix.fromPauliRotation(1 / 64, 0, 0),
    "X^⅟₃₂ Gate",
